  ...
  <div class="card card-body mb-3">
    <div class="row">
      <div  class="col-md-3">
        ...
        <a hef="${user.html_url}" target="_blank" class="btn btn-primary btn-block mb-4">View Profile</a>
        </div>
        <div class="col-md-9">
...
JSON.stringify(repos);
  repos.forEach(function(repo){
    ...
    <div class="row">
      <div class="col-md-6">
        <a href="${repo.html_url}" targrt="_blank">${repo.name}</a>
        </div>
        <div class="col-md-6">
